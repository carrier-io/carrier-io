...
curl -s https://raw.githubusercontent.com/carrier-io/carrier-io/master/demo_jenkins/datasource_telegraf | curl -X POST "http://${FULLHOST}/grafana/api/datasources" -u admin:password --header "Content-Type: application/json" -d @-
