(function (global, factory) {
  ...
  const c_wizard__toggle_list_item_first_child_FontSize = exports.c_wizard__toggle_list_item_first_child_FontSize = {
    "name": "--pf-c-wizard__toggle-list-item--first-child--FontSize",
    "value": "1.125rem",
    "var": "var(--pf-c-wizard__toggle-list-item--first-child--FontSize)"
  };
  ...
  const l_flex_flex_spacer = exports.l_flex_flex_spacer = {
    "name": "--pf-l-flex--flex--spacer",
    "value": "1.5rem",
    "var": "var(--pf-l-flex--flex--spacer)"
  };
  ...
  const chart_bullet_items_per_row = exports.chart_bullet_items_per_row = {
    "name": "--pf-chart-bullet--items-per-row",
    "value": 2,
    "var": "var(--pf-chart-bullet--items-per-row)"
  };
  const chart_bullet_legend_Height = exports.chart_bullet_legend_Height = {
    "name": "--pf-chart-bullet--legend--Height",
    "value": 30,
    "var": "var(--pf-chart-bullet--legend--Height)"
  };
  const chart_bullet_range_Width = exports.chart_bullet_range_Width = {
    "name": "--pf-chart-bullet--range--Width",
    "value": 40,
    "var": "var(--pf-chart-bullet--range--Width)"
  };
  const chart_bullet_threshold_error_Color = exports.chart_bullet_threshold_error_Color = {
    "name": "--pf-chart-bullet--threshold-error--Color",
    "value": "#c9190b",
    "var": "var(--pf-chart-bullet--threshold-error--Color)"
  };
  const chart_bullet_threshold_error_Width = exports.chart_bullet_threshold_error_Width = {
    "name": "--pf-chart-bullet--threshold-error--Width",
    "value": 2,
    "var": "var(--pf-chart-bullet--threshold-error--Width)"
  };
  const chart_bullet_value_Width = exports.chart_bullet_value_Width = {
    "name": "--pf-chart-bullet--value--Width",
    "value": 9,
    "var": "var(--pf-chart-bullet--value--Width)"
  };
  const chart_bullet_comparative_measure_line_warning_stroke_Color = exports.chart_bullet_comparative_measure_line_warning_stroke_Color = {
    "name": "--pf-chart-bullet--comparative-measure-line--warning--stroke--Color",
    "value": "#ec7a08",
    "var": "var(--pf-chart-bullet--comparative-measure-line--warning--stroke--Color)"
  };
  const chart_bullet_comparative_measure_line_warning_BorderWidth = exports.chart_bullet_comparative_measure_line_warning_BorderWidth = {
    "name": "--pf-chart-bullet--comparative-measure-line--warning--BorderWidth",
    "value": 1,
    "var": "var(--pf-chart-bullet--comparative-measure-line--warning--BorderWidth)"
  };
  const chart_bullet_comparative_measure_line_error_stroke_Color = exports.chart_bullet_comparative_measure_line_error_stroke_Color = {
    "name": "--pf-chart-bullet--comparative-measure-line--error--stroke--Color",
    "value": "#c9190b",
    "var": "var(--pf-chart-bullet--comparative-measure-line--error--stroke--Color)"
  };
  const chart_bullet_comparative_measure_line_error_BorderWidth = exports.chart_bullet_comparative_measure_line_error_BorderWidth = {
    "name": "--pf-chart-bullet--comparative-measure-line--error--BorderWidth",
    "value": 1,
    "var": "var(--pf-chart-bullet--comparative-measure-line--error--BorderWidth)"
  };
  const chart_bullet_zero_line_stroke_Color = exports.chart_bullet_zero_line_stroke_Color = {
    "name": "--pf-chart-bullet--zero-line--stroke--Color",
    "value": "#4d5258",
    "var": "var(--pf-chart-bullet--zero-line--stroke--Color)"
  };
  const chart_bullet_zero_line_BorderWidth = exports.chart_bullet_zero_line_BorderWidth = {
    "name": "--pf-chart-bullet--zero-line--BorderWidth",
    "value": 1,
    "var": "var(--pf-chart-bullet--zero-line--BorderWidth)"
  };
  const chart_bullet_negative_primary_measure_stroke_Color = exports.chart_bullet_negative_primary_measure_stroke_Color = {
    "name": "--pf-chart-bullet--negative-primary-measure--stroke--Color",
    "value": "#c9190b",
    "var": "var(--pf-chart-bullet--negative-primary-measure--stroke--Color)"
  };
  const chart_bullet_negative_primary_measure_BorderWidth = exports.chart_bullet_negative_primary_measure_BorderWidth = {
    "name": "--pf-chart-bullet--negative-primary-measure--BorderWidth",
    "value": 2,
    "var": "var(--pf-chart-bullet--negative-primary-measure--BorderWidth)"
  };
